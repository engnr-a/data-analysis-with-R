...
output:
  html_document:
    code_folding: none #the default of whether to show code or not. This can be overriden by the "echo" word in the actual code block. 
    df_print: paged    #dataframe display option. "paged" gives pageable table output
    highlight: tango  # Syntax hightlighting 
    number_sections: yes # gives page numbers to the TOC
    theme: flatly  #themes
    toc: yes
    toc_depth: 2
  pdf_document:
    toc: yes #inclusion of TOC
    toc_depth: '2'#the header level to be included in TOC
  word_document:
    toc: yes
    toc_depth: '2'
---
